...
function outlineInstruction(nodes, predicates, cats) {
  ...
  return [
    ...
    '- 예: "MASTER / ecamssh는 계정/비밀번호 쌍인가요?", "노트북 비밀번호는 어느 시스템 것인가요?"',
    '- **«SECRET#n»을 질문 문장에 쓰지 마라.** 사람에게는 뜻 모를 기호다 — 라벨로 가리켜라',
    '  (X: "«SECRET#4»는 어느 시스템 것인가요?" / O: "프로젝트뷰 계정 비밀번호는 어느 시스템 것인가요?").',
    '- 원문에 <b>[확인 답변]</b> 블록이 있으면 그건 <b>이미 사람이 답한 것</b>이다.'
      + ' 같은 것을 다시 묻지 말고 답을 반영해 분류해라.',
    '- 되물을 게 없으면 clarify는 빈 배열. 질문은 정말 막힐 때만 — 매번 물으면 사용자는 앞으로 못 간다.',
    '',
    '■ 그 밖의 필드 — 기존 규칙 그대로',
